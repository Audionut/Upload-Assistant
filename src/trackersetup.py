...
from src.trackers.BJ import BJ
...
tracker_class_map = {
    'ACM': ACM, 'AITHER': AITHER, 'AL': AL, 'ANT': ANT, 'AR': AR, 'ASC': ASC, 'BHD': BHD, 'BHDTV': BHDTV, 'BJ': BJ, 'BLU': BLU, 'BT': BT, 'CBR': CBR,
...
http_trackers = {
    'AR', 'ASC', 'BJ', 'BT', 'FL', 'HDB', 'HDS', 'HDT', 'MTV', 'PTER', 'TTG'
}
