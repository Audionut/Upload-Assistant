...
config = {
    ...
    "TRACKERS": {
        ...
        # Available tracker: A4K, ACM, AITHER, ANIRENA, ANT, AR, ASC, AZ, BHD, BHDTV, BJS, BLU, BT, CBR, CZ, DC, DP, DT, EMUW, FF, FL, FNP, FRIKI, GPW, HDB, HDS, HDT, HHD, HUNO, IHD, IS, ITT, LCD, LDU, LST, LT, LUME, MTV, NBL, OE, OTW, PHD, PT, PTER, PTP, PTS, PTT, R4E, RAS, RF, RTF, SAM, SHRI, SN, SP, SPD, STC, THR, TIK, TL, TLZ, TOS, TTG, TTR, TVC, ULCX, UTP, YOINK, YUS
        ...
        "ANIRENA": {
            # Instead of using the tracker acronym for folder name when sym/hard linking, you can use a custom name
            "link_dir_name": "",
            # You can find your api key under Your account -> API Key
            "api_key": "",
        },
        "ANT": {
            # Instead of using the tracker acronym for folder name when sym/hard linking, you can use a custom name
